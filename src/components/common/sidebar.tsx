...
const Sidebar: FC<SidebarProps> = ({
  ...
  return (
    <div className="sidebar w-full bg-white border-r border-gray-100 p-4 md:p-6 h-full">
      <div className="flex items-center justify-between md:block">
        ...
        <button 
          className="md:hidden text-gray-500 hover:text-blue-500 transition-colors duration-200"
      ...
      <div className={`space-y-6 mt-6 ${isMobileMenuOpen ? 'block' : 'hidden md:block'}`}>
